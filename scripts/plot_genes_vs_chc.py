...
scatter_gene_counts(gene_data_subsection, "mean", "ELO_chc", labelcol="species")
scatter_gene_counts_adv(gene_data_subsection, "mean", "ELO_chc", labelcol="species")
...
scatter_gene_counts_adv(gene_data_subsection, "methylbranched_richness", "FAS_chc", labelcol="species")
...
scatter_gene_counts_adv(gene_data_subsection, "unsaturated_richness","DESAT_chc", labelcol="species")
